...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "user",
        loadChildren: () => import("./chunk-5RD3TK35.js").then((m) => m.UserzModule)
      },
      {
        path: "account-in",
      ...
      {
        path: "edu",
        loadChildren: () => import("./chunk-XFZ7ELUE.js").then((m) => m.EduModule)
      },
      {
        path: "library",
        loadChildren: () => import("./chunk-UUX6VSOJ.js").then((m) => m.EduLibraryModule)
      },
      {
        path: "exam",
        loadChildren: () => import("./chunk-PKEFWUXN.js").then((m) => m.EduExamModule)
      },
      {
        path: "syllabus",
        loadChildren: () => import("./chunk-4IKNQVAF.js").then((m) => m.EduSyllabusModule)
      },
      {
        path: "question-bank",
        loadChildren: () => import("./chunk-23G5H737.js").then((m) => m.EduQuestionModule)
      },
      {
        path: "file-upload",
        loadChildren: () => import("./chunk-ULBPUCSM.js").then((m) => m.FileUploadModule)
      },
      {
        path: "notification",
...
//# sourceMappingURL=chunk-DWFXUBAA.js.map
