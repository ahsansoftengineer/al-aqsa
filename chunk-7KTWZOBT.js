...
var MenuFeatureIndex = class _MenuFeatureIndex extends BaseClassTemplate {
  static \u0275fac = /* @__PURE__ */ (() => {
    let \u0275MenuFeatureIndex_BaseFactory;
    return function MenuFeatureIndex_Factory(__ngFactoryType__) {
      return (\u0275MenuFeatureIndex_BaseFactory || (\u0275MenuFeatureIndex_BaseFactory = \u0275\u0275getInheritedFactory(_MenuFeatureIndex)))(__ngFactoryType__ || _MenuFeatureIndex);
    };
  })();
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MenuFeatureIndex, selectors: [["theme-menu-feature-index"]], hostAttrs: [1, "row", "mx-1"], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 3, vars: 1, consts: [[1, "row", "mx-1", "my-2"], [3, "item", "isModule"], ["contentz", ""], [1, "mt-5"], [1, "text-warning", "mb-5"], ["actionz", ""], ["align", "end", 2, "position", "absolute", "bottom", "5px", "right", "0px"], ["mat-button", "", "color", "primary", 3, "click", "routerLink"]], template: function MenuFeatureIndex_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MenuFeatureIndex, { className: "MenuFeatureIndex", filePath: "_core/_route/menu-feature-index/menu-feature-index.ts", lineNumber: 14 });
})();
...
var RoutezFeatureModule = class {
  ...
  feature(listComponent, addComponent, path, title) {
    this.routes.push({
      ...
      data: {
        title,
        linkPaginate: `/${this.routeModule}/${path}-list`,
        linkAdd: ``,
        linkUpdate: ``,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MenuIndexComponent, { className: "MenuIndexComponent", filePath: "_core/_route/menu-index/menu-index.ts", lineNumber: 17 });
})();
...
//# sourceMappingURL=chunk-7KTWZOBT.js.map
