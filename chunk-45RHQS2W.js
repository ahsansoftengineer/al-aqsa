...
var MenuIndexComponent = class _MenuIndexComponent {
  ...
  }, dependencies: [RouterLink, MatIcon, MatCard, MatCardAvatar, MatCardHeader, MatCardTitle, TranslatePipe], styles: ["/* src/_core/_route/menu-index/menu-index.component.scss */\n.menu-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(200px, 1fr));\n  gap: 20px;\n  padding: 20px;\n}\n.menu-card mat-card-header {\n  justify-content: space-between;\n}\n.mat-card-header-text {\n  margin: 0px !important;\n}\n.menu-card-body {\n  height: 50px;\n}\n/*# sourceMappingURL=menu-index.component-C2Y7EN3W.css.map */\n"], encapsulation: 2 });
};
(() => {
...
//# sourceMappingURL=chunk-45RHQS2W.js.map
