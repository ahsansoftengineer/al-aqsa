...
var ValidatorService = class _ValidatorService extends BaseClassNG {
  _fs;
  constructor() {
    super();
...
var ROUTEZ = [
  ...
  P("Education", "apartment", "\u{1F3EB}", "/feature/education", "Education Related Stuff", [
    ...
    C("Library", "museum", "\u{1F4DA}", "/feature/education/library"),
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MatDialogModule, [{
    type: NgModule,
    args: [{
      imports: [DialogModule, OverlayModule, PortalModule, ...DIRECTIVES2],
...
// src/_core/_dialog/dialog-common/dialog-common.ts
...
var DialogCommon = class _DialogCommon {
  ...
  }, dependencies: [MatButton, MatIconButton, MatIcon, MatCard, MatCardActions, MatCardContent, MatCardHeader], styles: ["/* angular:styles/component:scss;e0bf391dec6a5b2487f94fea535b85ad87152e18787e104e4ec937865b2d84be;C:/Work/edu-fe-admin/src/_core/_dialog/dialog-common/dialog-common.ts */\n:host {\n  display: block;\n}\nmat-card {\n  box-shadow: none;\n  overflow: hidden;\n  border: 2px solid black;\n}\nmat-card-title {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n.dialog-header {\n  display: flex;\n  justify-content: space-between;\n  width: 100%;\n  align-items: center;\n}\n.mat-mdc-dialog-surface {\n  background: transparent;\n  border-radius: 10px;\n}\n.mat-mdc-card-outlined {\n  border: transparent;\n}\n/*# sourceMappingURL=dialog-common.css.map */\n"], encapsulation: 2 });
};
(() => {
...
`, styles: ["/* angular:styles/component:scss;e0bf391dec6a5b2487f94fea535b85ad87152e18787e104e4ec937865b2d84be;C:/Work/edu-fe-admin/src/_core/_dialog/dialog-common/dialog-common.ts */\n:host {\n  display: block;\n}\nmat-card {\n  box-shadow: none;\n  overflow: hidden;\n  border: 2px solid black;\n}\nmat-card-title {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n.dialog-header {\n  display: flex;\n  justify-content: space-between;\n  width: 100%;\n  align-items: center;\n}\n.mat-mdc-dialog-surface {\n  background: transparent;\n  border-radius: 10px;\n}\n.mat-mdc-card-outlined {\n  border: transparent;\n}\n/*# sourceMappingURL=dialog-common.css.map */\n"] }]
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DialogCommon, { className: "DialogCommon", filePath: "_core/_dialog/dialog-common/dialog-common.ts", lineNumber: 39 });
})();

// src/_core/_dialog/dialog-common/srvc.dialog.ts
...
// src/_core/_dialog/dialog-common/srvc.dialog.wrapper.ts
...
// src/_core/_dialog/notify-container/srvc.notify.ts
...
// src/_core/_dialog/notify-container/notify-card/notify-card.ts
...
var NotifyCard = class _NotifyCard {
  ...
  }, dependencies: [MatButton, MatIconButton, MatIcon, MatCard, MatCardActions, MatCardContent, MatExpansionPanel, MatExpansionPanelHeader, MatProgressBar], styles: ["/* src/_core/_dialog/notify-container/notify-card/notify-card.scss */\n.header {\n  display: flex;\n  justify-content: space-between;\n  align-items: start;\n  padding: 8px 16px;\n}\n.title {\n  display: flex;\n  gap: 10px;\n}\n.heading {\n  font-weight: 600;\n}\n.validation-item {\n  padding: 8px 0;\n  border-bottom: 1px solid #eee;\n}\npre {\n  white-space: pre-wrap;\n  word-break: break-word;\n}\n/*# sourceMappingURL=notify-card.css.map */\n"], encapsulation: 2 });
};
(() => {
...
`, styles: ["/* src/_core/_dialog/notify-container/notify-card/notify-card.scss */\n.header {\n  display: flex;\n  justify-content: space-between;\n  align-items: start;\n  padding: 8px 16px;\n}\n.title {\n  display: flex;\n  gap: 10px;\n}\n.heading {\n  font-weight: 600;\n}\n.validation-item {\n  padding: 8px 0;\n  border-bottom: 1px solid #eee;\n}\npre {\n  white-space: pre-wrap;\n  word-break: break-word;\n}\n/*# sourceMappingURL=notify-card.css.map */\n"] }]
  }], null, { data: [{
    type: Input,
    args: [{ required: true }]
  }] });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NotifyCard, { className: "NotifyCard", filePath: "_core/_dialog/notify-container/notify-card/notify-card.ts", lineNumber: 22 });
})();

// src/_core/_dialog/notify-container/notify-container.ts
...
var NotifyContainer = class _NotifyContainer {
  ...
  }, dependencies: [NotifyCard], styles: ["/* angular:styles/component:scss;6fd00d240d94190a5f083503c0d22b7b6f23ab02881097c72e674d264d5bd68f;C:/Work/edu-fe-admin/src/_core/_dialog/notify-container/notify-container.ts */\n.notify-container {\n  position: fixed;\n  top: 16px;\n  right: 16px;\n  width: 450px;\n  max-width: 95vw;\n  max-height: 80vh;\n  overflow-y: auto;\n  z-index: 99999;\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n}\n/*# sourceMappingURL=notify-container.css.map */\n"], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NotifyContainer, [{
    type: Component,
    args: [{ encapsulation: ViewEncapsulation.None, changeDetection: ChangeDetectionStrategy.OnPush, standalone: false, selector: "notify-container", template: '<div class="notify-container">\r\n  @for(item of service.notifications(); track item.id){\r\n  <notify-card [data]="item"> </notify-card>\r\n  }\r\n</div>\r\n', styles: ["/* angular:styles/component:scss;6fd00d240d94190a5f083503c0d22b7b6f23ab02881097c72e674d264d5bd68f;C:/Work/edu-fe-admin/src/_core/_dialog/notify-container/notify-container.ts */\n.notify-container {\n  position: fixed;\n  top: 16px;\n  right: 16px;\n  width: 450px;\n  max-width: 95vw;\n  max-height: 80vh;\n  overflow-y: auto;\n  z-index: 99999;\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n}\n/*# sourceMappingURL=notify-container.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NotifyContainer, { className: "NotifyContainer", filePath: "_core/_dialog/notify-container/notify-container.ts", lineNumber: 26 });
})();
...
// src/_core/_pagination/builder.list.0.base.ts
var LB_Base = class {
  httpReqPaginate;
  colsExtra;
  _httpUOW;
  ...
  // Data Source
  cols = [];
  constructor(httpReqPaginate, colsExtra = []) {
    this.httpReqPaginate = httpReqPaginate;
    this.colsExtra = colsExtra;
    this._httpUOW = AppInjector.get(HTTP_UOW);
    this._dialog = AppInjector.get(DialogCommonService);
    this._notify = AppInjector.get(NotifyService);
  ...
  initCols(colsExtra) {
    ...
    this.cols = ["id", "name", ...finalCol, "status", "desc", "updatedAt", "actions"];
  }
};

// src/_core/_pagination/builder.list.1.api.ts
var LB_Base_API = class extends LB_Base {
  // Get Paginate API
  hitApi = (next = this.next, error = this.error, complete = this.complete, beforeHit = this.beforeHit) => {
    beforeHit().subscribe({
      next: () => {
        this._httpUOW.Client.GetsPaginate(this.httpReqPaginate).subscribe({ next, error, complete });
      }
    });
  };
  beforeHit = () => {
...
// src/_core/_pagination/builder.list.2.sort.paginate.filter.ts
var LB_Base_SortPaginateFilter = class extends LB_Base_API {
  filterRequiredShow = false;
  filterDefaultShow = false;
  filterAdvanceShow = false;
  filterRequired = new FormGroup({});
  ...
  reset() {
    ...
    this.httpReqPaginate.body = {
      pageNo: 1,
      pageSize: 25,
      filter: __spreadValues({}, this.filterRequired?.value),
      sort: {
        by: null,
        order: null
      }
  ...
  fresh() {
    ...
    this._notify.clear();
    this.httpReqPaginate.body.filter = __spreadValues(__spreadValues(__spreadValues({}, this.filterRequired?.value), this.filterDefault.value), this.filterAdvance?.value);
    this.hitApi();
  }
  refresh() {
    this.reset();
...
// src/_core/_pagination/builder.list.3.actions.ts
var LB_Actions = class extends LB_Base_SortPaginateFilter {
  httpReqPaginate;
  colsExtra;
  httpReqStatus = {};
  httpReqDelete = {};
  httpReqUpdateDelete = {};
  constructor(httpReqPaginate, colsExtra = []) {
    super(httpReqPaginate, colsExtra);
    this.httpReqPaginate = httpReqPaginate;
    this.colsExtra = colsExtra;
    return this;
  }
  updateStatus(item) {
    ...
    const subs = isNotActive ? this._dialog.confirmSuccess("Record will be Activated") : this._dialog.confirmWarn("Record will be De-Activated");
    subs.subscribe({
      next: (val) => {
        if (val) {
          this._httpUOW.Client.UpdateStatus(this.httpReqStatus).subscribe({
            next: (res) => {
              if (res.record) {
                item.status = res?.record?.status;
                this._dialog.info(`Record Status ${item?.status} Successfully.`);
              }
            }
          });
        }
      ...
      error: () => {
        this._dialog.error("Status not Updated!");
      }
    });
  }
  // Neet to Work
  updateDelete(item) {
    ...
    this._dialog.confirmWarn("Record will be Soft Deleted").subscribe({
      next: (val) => {
        if (val) {
          this._httpUOW.Client.UpdateDelete(this.httpReqUpdateDelete).subscribe({
            next: (res) => {
              if (res?.status == "OK") {
                this._dialog.info("Record Soft Deleted Successfully.");
                this.fresh();
              }
            }
          });
      ...
      error: () => {
        this._dialog.error("Record not Deleted!");
      }
    });
  }
  Delete(item) {
    ...
    this._dialog.confirmDanger("Record will be Permenently Deleted.").subscribe({
      next: (val) => {
        if (val) {
          this._httpUOW.Client.Delete(this.httpReqDelete).subscribe({
            next: (res) => {
              if (res?.status == "OK") {
                this.fresh();
                this._dialog.warning("Record Permenently Deleted Successfully.");
              }
            }
          });
        }
  ...
  printList() {
    ...
    this.httpResPaginate.records;
  }
  exportListToCSV() {
    console.log("exportListToCSV");
    this.httpResPaginate.records;
  }
  exportListToJSON() {
    console.log("exportListToJSON");
    this.httpResPaginate.records;
  }
  copyListJSON() {
    console.log("copyListJSON");
    this.httpResPaginate.records;
  }
  copyItemJSON(item) {
    console.log("copyItemJSON");
    item;
  }
  copyValue(value) {
...
// src/_core/_pagination/builder.list.4.expose.ts
var LB = class extends LB_Actions {
};
...
var TemplateService = class _TemplateService {
  ...
  linkUpdate = "";
  ActionFormSave = () => {
    console.log("ActionFormSave");
  };
  ActionFormCancel = () => {
    console.log("ActionFormCancel");
  };
  ActionFormReset = () => {
    console.log("ActionFormReset");
  };
  DATA = new Subject();
  _cdr;
  lb = new LB({});
...
// src/_core/__base/base.class.b.inject.ts
var BaseClassProp = class _BaseClassProp extends BaseClassNG {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BaseClassProp, { className: "BaseClassProp", filePath: "_core/__base/base.class.b.inject.ts", lineNumber: 17 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BaseClassTemplate, { className: "BaseClassTemplate", filePath: "_core/__base/base.class.e.template.ts", lineNumber: 6 });
})();
...
var FormService = class _FormService extends BaseClassNG {
  _notify;
  _form;
  _isSubmitted = false;
  _showWarning = false;
  ...
  static \u0275fac = function FormService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _FormService)(\u0275\u0275inject(NotifyService));
  };
...
(() => {
  ...
  }], () => [{ type: NotifyService }], null);
})();

// src/_core/_form/class/2.form.inject.ts
var FormSubmit_Inject = class {
  _fs;
  _httpUOW;
  _vs;
  _dialog;
  ...
  _router;
  _route;
  // public _template: TemplateService
  _translate;
  constructor() {
    this._fs = AppInjector.get(FormService);
    this._httpUOW = AppInjector.get(HTTP_UOW);
...
// src/_core/_form/class/3.form.submit.http.ts
var FormSubmitHttpService = class extends FormSubmit_Inject {
  route;
  httpReqGet;
  httpResSingle = new Subject();
  httpReqCreate = {};
  httpReqUpdate = {};
  constructor(httpReq, route = null) {
    super();
    this.route = route;
    this._route = route;
  ...
  getById() {
    if (!this.httpReqGet.resource) {
      this.httpReqGet.resource = this._route.snapshot.paramMap.get("id");
    }
    console.log(this.httpReqGet.resource);
    if (this.httpReqGet.resource) {
      this._httpUOW.Client.Get(this.httpReqGet).subscribe({
        next: (res) => {
  ...
  create() {
    ...
    this.httpReqCreate.body = this._fs._form.value();
    return this._httpUOW.Client.Add(this.httpReqCreate);
  }
  update() {
    ...
    this.httpReqUpdate.body = this._fs._form.value;
    return this._httpUOW.Client.Update(this.httpReqUpdate);
  }
  onNext(res) {
    if (res.status == "OK") {
      const msg = `Record ${this.httpReqGet.resource ? " Updated" : " Created"} Successfully`;
      this._dialog.info(this._translate.instant(msg)).subscribe({
        next: () => {
...
// src/_core/_form/class/4.form.submit.ts
var FSB = class extends FormSubmitHttpService {
  submit() {
    this.beforeSubmit();
    if (this._fs._form.invalid) {
      return;
    }
    const prompt = this.httpReqGet.resource ? this._dialog.confirmSuccess("Record will be updated") : this._dialog.confirmSuccess("A new Record will be Created.");
    prompt.subscribe({
      next: (val) => {
        if (val)
          this.execute();
...
//# sourceMappingURL=chunk-R6H5ONSM.js.map
