...
(function(URL_CONTRL_EDU2) {
  ...
  URL_CONTRL_EDU2["Attendance"] = "_projectz-lookup-base";
...
var TM_Base = class {
  ...
  initCols(colsExtra) {
    ...
    this.cols = ["id", "name", "status", ...finalCol, "updatedAt", "actions"];
  }
};
...
var ROUTEZ = [
  ...
  P("Attendance", "list_alt_check", "\u2705", "/feature/attendance", "Check-in Check-out Details", [
    C("Check In", "list_alt_check", "\u2705", "/feature/attendance/check-in")
  ]),
  P("Prints", "receipt", "\u{1F5A8}\uFE0F", "/feature/print/admission", "Printable Forms, Summary and Reports", [
    C("Admission Form", "article", "\u{1F4C4}", "admission"),
    C("Attendance Summary", "article", "\u{1F4CA}", "attendance-summary"),
    C("Explanation", "article", "\u{1F4C3}", "explanation"),
    C("Leave Form", "article", "\u{1F4DD}", "leave-form"),
    C("Result", "article", "\u{1F3C6}", "result")
  ]),
...
function MenuModuleIndex_For_2_For_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(4, _c15, it_r1.link));
    \u0275\u0275advance(2);
...
function MenuModuleIndex_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275repeater(item_r2?.submenu ?? \u0275\u0275pureFunction0(2, _c05));
  }
}
var MenuModuleIndex = class _MenuModuleIndex {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MenuModuleIndex, selectors: [["theme-menu-module-index"]], hostAttrs: [1, "row", "mx-1"], standalone: false, decls: 3, vars: 1, consts: [[1, "row", "mx-0", "px-0", "my-2"], [3, "item", "isModule"], ["contentz", ""], [1, "mt-5"], [1, "me-1", "mb-1", 3, "click", "routerLink"], [2, "cursor", "pointer"]], template: function MenuModuleIndex_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275repeaterCreate(1, MenuModuleIndex_For_2_Template, 5, 3, "theme-menu-index", 1, _forTrack02);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
//# sourceMappingURL=chunk-KUIYJW6G.js.map
