...
// src/_core/_client/http.endpoints.ts
var EP;
(function(EP2) {
  EP2["NotSet"] = "NO_SET";
  EP2["None"] = "NONE";
...
// src/_core/_client/http.srvc.attendance.ts
var URL_CONTRL_Attendance;
(function(URL_CONTRL_Attendance2) {
  URL_CONTRL_Attendance2["ProjectzLookup"] = "_projectz-lookup";
  URL_CONTRL_Attendance2["ProjectzLookupBase"] = "_projectz-lookup-base";
  URL_CONTRL_Attendance2["CheckIn"] = "_projectz-lookup-base";
})(URL_CONTRL_Attendance || (URL_CONTRL_Attendance = {}));

// src/_core/_client/http.srvc.edu.ts
var URL_CONTRL_EDU;
(function(URL_CONTRL_EDU2) {
  ...
  URL_CONTRL_EDU2["ClassRoutine"] = "_projectz-lookup-base";
  ...
  URL_CONTRL_EDU2["Chapter"] = "_projectz-lookup-base";
  URL_CONTRL_EDU2["QuestionType"] = "_projectz-lookup-base";
  URL_CONTRL_EDU2["Question"] = "_projectz-lookup-base";
  URL_CONTRL_EDU2["ExamType"] = "_projectz-lookup-base";
  URL_CONTRL_EDU2["Exam"] = "_projectz-lookup-base";
  URL_CONTRL_EDU2["ExamSubjectz"] = "_projectz-lookup-base";
  URL_CONTRL_EDU2["Grade"] = "_projectz-lookup-base";
  URL_CONTRL_EDU2["Result"] = "_projectz-lookup-base";
  URL_CONTRL_EDU2["Term"] = "_projectz-lookup-base";
  URL_CONTRL_EDU2["StudentPromote"] = "_projectz-lookup-base";
})(URL_CONTRL_EDU || (URL_CONTRL_EDU = {}));

// src/_core/_client/http.srvc.userz.ts
...
// src/_core/_client/http.srvc..ts
var URL_SRVC;
(function(URL_SRVC2) {
  ...
  URL_SRVC2["Exam"] = "Exam";
  URL_SRVC2["Attendance"] = "Edu";
})(URL_SRVC || (URL_SRVC = {}));
var URL_CONTRL = {
  Userz: URL_CONTRL_USERZ,
  Edu: URL_CONTRL_EDU,
  Attendance: URL_CONTRL_Attendance
};
...
var HttpBaseService = class {
  ...
  setURL(httpRequest) {
    ...
    let result = "";
    if (httpRequest.srvcCntrl)
      result = `${httpRequest.domain || this.domain}/${httpRequest.srvcCntrl}`;
    else
      result = `${httpRequest.domain || this.domain}/${httpRequest.srvc || this.srvc}/v1/${httpRequest.cntrl}`;
    if (httpRequest?.ep)
...
var HTTPEnpointsService = class {
  ...
  UpdateStatus(req) {
    req.ep = EP.UpdateStatus;
    return this.client.Patch(req);
  }
  UpdateDelete(req) {
    req.ep = EP.UpdateDelete;
    return this.client.Patch(req);
  }
  Delete(req) {
    req.ep = EP.Delete;
  ...
  GetsLookup(req) {
    req.ep = EP.GetsLookup;
    return this.client.Get(req);
  }
  GetsByIdsLookup(req) {
    req.ep = EP.GetsByIdsLookup;
    return this.client.Post(req);
  }
  GetsPaginate(req) {
    req.ep = EP.GetsPaginate;
    return this.client.Post(req);
  }
  GetsPaginateOptions(req) {
    req.ep = EP.GetsPaginateOptions;
    return this.client.Post(req);
  }
  GetsCSV(req) {
    req.ep = EP.GetsCSV;
...
var TM_Base = class {
  ...
  initCols(colsExtra) {
    ...
    this.cols = ["name", "status", ...finalCol, "updatedAt", "actions"];
  }
};
...
var TM_Base_API = class extends TM_Base {
  ...
  hitApi = (next = this.next, error = this.error, complete = this.complete, beforeHit = this.beforeHit) => {
    ...
    beforeHit().subscribe({
      next: () => {
        this._bcs._httpUwo.Client.GetsPaginate(this.httpReqPaginate).subscribe({
          next,
          error,
          complete
        });
  ...
  // Complete Doesn't Called on Error
  complete = () => {
    this.finishCall();
  };
  finishCall = () => {
...
var TM_Actions = class extends TM_Base_SortPaginate {
  ...
  showID() {
    this.cols.splice(0, 0, "id");
  }
  showSNo() {
    this.cols.splice(0, 0, "sno");
  }
};
...
var DialogCommon = class _DialogCommon {
  ...
  }, dependencies: [MatButton, MatIconButton, MatIcon, MatCard, MatCardActions, MatCardContent, MatCardHeader, TranslatePipe], styles: ["/* angular:styles/component:scss;e0bf391dec6a5b2487f94fea535b85ad87152e18787e104e4ec937865b2d84be;C:/Work/edu-fe-admin/src/_core/components/dialog/dialog-common/dialog-common.ts */\n:host {\n  display: block;\n}\nmat-card {\n  box-shadow: none;\n  overflow: hidden;\n  border: 2px solid black;\n}\nmat-card-title {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n.dialog-header {\n  display: flex;\n  justify-content: space-between;\n  width: 100%;\n  align-items: center;\n}\n.mat-mdc-dialog-surface {\n  background: transparent;\n  border-radius: 10px;\n}\n.mat-mdc-card-outlined {\n  border: transparent;\n}\n/*# sourceMappingURL=dialog-common-CVRNIIH6.css.map */\n"], encapsulation: 2 });
};
(() => {
...
var NotifyContainer = class _NotifyContainer {
  ...
  }, dependencies: [NotifyCard], styles: ["/* angular:styles/component:scss;e2df0247cf430df691de52825f5803e8b61f26bfc850956da615cf1c08b683f7;C:/Work/edu-fe-admin/src/_core/components/dialog/notify-container/notify-container.ts */\n.notify-container {\n  position: fixed;\n  top: 16px;\n  right: 16px;\n  width: 450px;\n  max-width: 95vw;\n  max-height: 80vh;\n  overflow-y: hidden;\n  z-index: 99999;\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n}\n/*# sourceMappingURL=notify-container-AEWMWIUI.css.map */\n"], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NotifyContainer, [{
    type: Component,
    args: [{ encapsulation: ViewEncapsulation.None, changeDetection: ChangeDetectionStrategy.OnPush, standalone: false, selector: "notify-container", template: '<div class="notify-container">\r\n  @for(item of service.notifications(); track item.id){\r\n  <notify-card [data]="item"> </notify-card>\r\n  }\r\n</div>\r\n', styles: ["/* angular:styles/component:scss;e2df0247cf430df691de52825f5803e8b61f26bfc850956da615cf1c08b683f7;C:/Work/edu-fe-admin/src/_core/components/dialog/notify-container/notify-container.ts */\n.notify-container {\n  position: fixed;\n  top: 16px;\n  right: 16px;\n  width: 450px;\n  max-width: 95vw;\n  max-height: 80vh;\n  overflow-y: hidden;\n  z-index: 99999;\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n}\n/*# sourceMappingURL=notify-container-AEWMWIUI.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
function P(title, icon, emoji, link, desc, submenu) {
  return __spreadProps(__spreadValues(__spreadValues({}, CB(title, icon, emoji, link, desc)), defaultParent), {
    submenu: submenu.map((x) => __spreadProps(__spreadValues({}, x), { link: `${link}/${x.link}` }))
  });
}
function C(title, icon, emoji, link, desc = "") {
  return CB(title, icon, emoji, `${link}-list`, desc);
}
function CB(title, icon, emoji, link, desc = "") {
...
var ROUTEZ = [
  P("Dashboard", "dashboard", "\u{1F4CA}", "/dashboard", "Admin, Teacher, Parent, Student, Dashboards and their metrics, charts, etc...", [
    C("Finance", "stacked_bar_chart", "\u{1F4B0}", "finance"),
    C("Admin", "admin_panel_settings", "\u{1F6E1}\uFE0F", "admin"),
    C("Teachers", "school", "\u{1F468}\u200D\u{1F3EB}", "teachers"),
    C("Parents", "family_restroom", "\u{1F468}\u200D\u{1F469}\u200D\u{1F467}\u200D\u{1F466}", "parents"),
    C("Students", "mood", "\u{1F393}", "students")
  ]),
  P("User", "diversity_3", "\u{1F465}", "/feature/user", "All the Userz", [
    C("User Type", "groups_3", "\u{1F3F7}\uFE0F", "user-type"),
    C("Admin", "admin_panel_settings", "\u{1F6E1}\uFE0F", "admin"),
    C("Teacher", "school", "\u{1F468}\u200D\u{1F3EB}", "teacher"),
    C("Parents", "family_restroom", "\u{1F468}\u200D\u{1F469}\u200D\u{1F467}\u200D\u{1F466}", "parent"),
    C("Students", "mood", "\u{1F393}", "student")
  ]),
  P("Education", "apartment", "\u{1F3EB}", "/feature/edu", "Education Related Stuff", [
    C("Institute", "add_home_work", "\u{1F3E2}", "institute"),
    C("Class", "other_houses", "\u{1F3D8}\uFE0F", "class"),
    C("Section", "house_siding", "\u{1F6AA}", "section"),
    C("Class Section", "house_siding", "\u{1F6AA}", "class-section"),
    C("Class Routine", "assignment_add", "\u{1F4C5}", "class-routine"),
    C("Student Promote", "add_chart", "\u2B06\uFE0F", "student-promote")
  ]),
  P("Syllabus", "menu_book", "\u{1F4D6}", "/feature/syllabus", "Syllabus Related Stuff", [
    C("Subject", "language_chinese_dayi", "\u{1F4DD}", "subject"),
    C("Book", "menu_book", "\u{1F4DA}", "book"),
    C("Chapter", "book_ribbon", "\u{1F4D1}", "chapter")
  ]),
  P("Question Bank", "contact_support", "\u2753", "/feature/question-bank", "Question", [
    C("Question Type", "contact_support", "\u2753", "question-type"),
    C("Question", "contact_support", "\u2753", "question")
  ]),
  P("Exam", "assignment", "\u{1F4DD}", "/feature/exam", "Exam Related Stuff", [
    C("Exam Type", "content_paste_search", "\u{1F4CB}", "exam-type"),
    C("Exam", "calendar_month", "\u{1F4CB}", "exam"),
    C("Exam Subject", "calendar_month", "\u{1F4CB}", "exam-subject"),
    C("Grade", "percent", "\u{1F4AF}", "grade"),
    C("Result", "stars_2", "\u{1F3C6}", "result")
  ]),
  P("Attendance", "list_alt_check", "\u2705", "/feature/attendance", "Check-in Check-out Details", [
    C("Check In", "list_alt_check", "\u2705", "check-in")
  ]),
  P("Library", "apartment", "\u{1F3EB}", "/feature/library", "Library Related Stuff", [
    C("Library", "museum", "\u{1F4DA}", "library"),
    C("Library Cabinet", "museum", "\u{1F4DA}", "library-cabinet"),
    C("Library Shelf", "museum", "\u{1F4DA}", "library-shelf"),
    C("Library Book", "museum", "\u{1F4DA}", "library-book"),
    C("Book Issue", "museum", "\u{1F4DA}", "book-issue")
  ]),
  P("Account In", "paid", "\u{1F4B5}", "/feature/account-in/donar-type", "All the income records", [
    C("Donar Type", "volunteer_activism", "\u{1F91D}", "donar-type"),
    C("Donation Type", "volunteer_activism", "\u{1F381}", "donation-type"),
    C("Donation Box", "how_to_vote", "\u{1F4E6}", "donation-box"),
    C("Donar", "volunteer_activism", "\u{1F64B}", "donar"),
    C("Account Type", "volunteer_activism", "\u{1F3E6}", "account-type"),
    C("Fees", "currency_bitcoin", "\u{1F4B3}", "fees")
  ]),
  P("Account Out", "money_off", "\u{1F4B8}", "/feature/account-out", "All the Expenses related to purchasing, payable amount records", [
    C("Expense Type", "area_chart", "\u{1F4C9}", "expense-type"),
    C("Expenses", "bar_chart", "\u{1F9FE}", "expenses"),
    C("Teacher Payment", "payments", "\u{1F4B0}", "teacher-payment"),
    C("Teacher Advance Payment", "money_bag", "\u{1F4B5}", "teacher_advance_payment")
  ]),
  // P('Notice', 'assignment', '📢', '/feature/notice', 'School, Student, Teacher Notices',
  // [
  //   C('School Notice', 'cash', '🏫', 'school'),
  //   C('Student Notice', 'cash', '🎓', 'student'),
  //   C('Teacher Notice', 'cash', '👨‍🏫', 'teacher'),
  // ]),
  // P('Transport', 'account_balance', '🚌', '/feature/transport', 'Transport Management System',
  // [
  //   C('Vehicle Type', 'cash', '🚗', 'transport-type'),
  //   C('Vehicle', 'cash', '🚐', 'vehicle'),
  // ]),
  // P('Hostel', 'account_balance', '🏨', '/feature/hostel', 'Hostel Management System',
  // [
  //   C('Room', 'cash', '🛏️', '/feature/hostel/room'),
  // ]),
  // File Uploading Should be handle throw popup
  // Uploaded File Record Should be track here
  P("File Upload", "cloud_upload", "\u2601\uFE0F", "/feature/file", "Manage Files on Cloud", [
    C("File Type", "image", "\u{1F5BC}\uFE0F", "file-type"),
    C("File Upload", "upload", "\u{1F4E4}", "file-upload")
  ]),
  P("Prints", "receipt", "\u{1F5A8}\uFE0F", "/print", "Printable Forms, Summary and Reports", [
    CB("Form Admission", "article", "\u{1F4C4}", "form-admission"),
    CB("Form Explation", "article", "\u{1F4CA}", "form-explanation"),
    CB("Form Leave", "article", "\u{1F4C3}", "form-leave"),
    CB("Report Attendace", "article", "\u{1F4DD}", "report-attendance"),
    CB("Result", "article", "\u{1F3C6}", "result")
  ])
];
...
var StateService = class _StateService {
  injector;
  // TRANSACTION
  navgationSubs = new BehaviorSubject(null);
  activeSideBarParent;
  sideBarMenus;
  sideBarMenusFlat = [];
  permission;
  ...
  ORDER = Array.from({ length: 101 }, (_, i) => ({ id: i, name: i }));
...
// src/_core/components/loader/loader.ts
...
function FormId(that, d = {}) {
  return {
    id: [{ disabled: false, value: d?.id || "" }]
  };
}
function FormDesc(that, d = {}) {
  return {
    desc: [{ disabled: false, value: d?.desc || "" }, that._vs._val("", { maxChar: 255, specialChar: 1 })]
  };
}
function FormDate(that, d = {}) {
  return __spreadProps(__spreadValues({}, FormId(that, d)), {
...
function FormBase(that, d = {}) {
  return __spreadValues(__spreadProps(__spreadValues({}, FormDate(that, d)), {
    name: [{ disabled: false, value: d?.name || "" }, that._vs._val("Name", { minChar: 3, alphaNum: 1 })],
    status: [{ disabled: false, value: d?.status || "" }]
  }), FormDesc(that, d));
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MatSnackBarModule, [{
    type: NgModule,
    args: [{
      imports: [OverlayModule, PortalModule, MatButtonModule, SimpleSnackBar, ...DIRECTIVES2],
      exports: [BidiModule, ...DIRECTIVES2],
      providers: [MatSnackBar]
    }]
  }], null, null);
})();
...
var BaseClassTemplate = class _BaseClassTemplate extends BaseClassFuncs {
  ...
  ngOnDestroy() {
    super.ngOnDestroy();
    this._template.lb = null;
    this._template.linkAdd = "";
    this._template.linkUpdate = "";
    this._template.linkPaginate = "";
    this._template.layer = [""];
    this._template.title = "Destroyed";
  }
...
//# sourceMappingURL=chunk-MEB3TIJQ.js.map
