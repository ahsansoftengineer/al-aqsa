...
// src/app/feature-auth/sign-in/sign-in.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignInComponent, { className: "SignInComponent", filePath: "app/feature-auth/sign-in/sign-in.ts", lineNumber: 11 });
})();

// src/app/feature-auth/sign-up/sign-up.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignUpComponent, { className: "SignUpComponent", filePath: "app/feature-auth/sign-up/sign-up.ts", lineNumber: 11 });
})();

// src/app/feature-auth/forget-password/forget-password.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ForgetPasswordComponent, { className: "ForgetPasswordComponent", filePath: "app/feature-auth/forget-password/forget-password.ts", lineNumber: 11 });
})();
...
//# sourceMappingURL=chunk-2CRLWTNU.js.map
