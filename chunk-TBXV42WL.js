...
var MatFormField = class _MatFormField {
  ...
  _initializeControl(previousControl) {
    const control2 = this._control;
    const classPrefix = "mat-mdc-form-field-type-";
    if (previousControl) {
      this._elementRef.nativeElement.classList.remove(classPrefix + previousControl.controlType);
    }
    if (control2.controlType) {
      this._elementRef.nativeElement.classList.add(classPrefix + control2.controlType);
    }
    this._stateChanges?.unsubscribe();
    this._stateChanges = control2.stateChanges.subscribe(() => {
      this._updateFocusState();
      this._changeDetectorRef.markForCheck();
    });
    this._describedByChanges?.unsubscribe();
    this._describedByChanges = control2.stateChanges.pipe(startWith([void 0, void 0]), map(() => [control2.errorState, control2.userAriaDescribedBy]), pairwise(), filter(([[prevErrorState, prevDescribedBy], [currentErrorState, currentDescribedBy]]) => {
      return prevErrorState !== currentErrorState || prevDescribedBy !== currentDescribedBy;
    })).subscribe(() => this._syncDescribedByIds());
    this._valueChanges?.unsubscribe();
    if (control2.ngControl && control2.ngControl.valueChanges) {
      this._valueChanges = control2.ngControl.valueChanges.pipe(takeUntil(this._destroyed)).subscribe(() => this._changeDetectorRef.markForCheck());
    }
  }
  ...
  _shouldForward(prop) {
    const control2 = this._control ? this._control.ngControl : null;
    return control2 && control2[prop];
  }
...
var ShowOnDirtyErrorStateMatcher = class _ShowOnDirtyErrorStateMatcher {
  isErrorState(control2, form) {
    return !!(control2 && control2.invalid && (control2.dirty || form && form.submitted));
  }
...
var ErrorStateMatcher = class _ErrorStateMatcher {
  isErrorState(control2, form) {
    return !!(control2 && control2.invalid && (control2.touched || form && form.submitted));
  }
...
var _ErrorStateTracker = class {
  ...
  updateErrorState() {
    ...
    const control2 = this.ngControl ? this.ngControl.control : null;
    const newState = matcher?.isErrorState(control2, parent) ?? false;
...
var _c05 = ["*", [["", "matSortHeaderIcon", ""]]];
var _c14 = ["*", "[matSortHeaderIcon]"];
...
// src/_shared/table/tbl-paginator/tbl-paginator.component.ts
var _c06 = () => [10, 20, 25, 50, 100, 200, 250, 500, 1e3];
function TblPaginatorComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-paginator", 2);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("length", ctx_r1.lb?.httpResPaginate?.count)("pageIndex", ctx_r1.lb.httpReqPaginate?.body?.pageNo - 1)("pageSize", ctx_r1.lb?.httpReqPaginate?.body?.pageSize)("pageSizeOptions", \u0275\u0275pureFunction0(4, _c06));
  }
}
function TblPaginatorComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-paginator", 3);
    \u0275\u0275listener("page", function TblPaginatorComponent_Conditional_1_Template_mat_paginator_page_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.lb?.paginate($event));
    });
...
var TblPaginatorComponent = class _TblPaginatorComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TblPaginatorComponent, selectors: [["tbl-paginator"]], inputs: { lb: "lb" }, standalone: false, decls: 2, vars: 1, consts: [["showFirstLastButtons", "", 3, "length", "pageIndex", "pageSize", "pageSizeOptions"], [3, "length", "pageIndex", "pageSize"], ["showFirstLastButtons", "", 3, "page", "length", "pageIndex", "pageSize", "pageSizeOptions"], [3, "page", "length", "pageIndex", "pageSize"]], template: function TblPaginatorComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, TblPaginatorComponent_Conditional_0_Template, 1, 5, "mat-paginator", 0)(1, TblPaginatorComponent_Conditional_1_Template, 1, 3, "mat-paginator", 1);
    }
    if (rf & 2) {
      \u0275\u0275conditional(ctx._template.LG && ctx.lb?.httpReqPaginate?.body?.pageNo ? 0 : ctx.lb?.httpReqPaginate?.body?.pageNo ? 1 : -1);
    }
  }, dependencies: [MatPaginator], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TblPaginatorComponent, [{
    type: Component,
    args: [{ standalone: false, encapsulation: ViewEncapsulation.None, changeDetection: ChangeDetectionStrategy.OnPush, selector: "tbl-paginator", template: '@if(_template.LG && lb?.httpReqPaginate?.body?.pageNo){\r\n<mat-paginator\r\n  [length]="lb?.httpResPaginate?.count"\r\n  [pageIndex]="lb.httpReqPaginate?.body?.pageNo - 1"\r\n  [pageSize]="lb?.httpReqPaginate?.body?.pageSize"\r\n  (page)="lb?.paginate($event)"\r\n  [pageSizeOptions]="[10, 20, 25, 50, 100, 200, 250, 500, 1000]"\r\n  showFirstLastButtons\r\n></mat-paginator>\r\n} @else if(lb?.httpReqPaginate?.body?.pageNo){\r\n<mat-paginator\r\n  [length]="lb?.httpResPaginate?.count"\r\n  [pageIndex]="lb.httpReqPaginate?.body?.pageNo - 1"\r\n  [pageSize]="lb?.httpReqPaginate?.body?.pageSize"\r\n  (page)="lb?.paginate($event)"\r\n></mat-paginator>\r\n}\r\n\r\n' }]
  }], () => [{ type: TemplateService }], { lb: [{
    type: Input
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TblPaginatorComponent, { className: "TblPaginatorComponent", filePath: "_shared/table/tbl-paginator/tbl-paginator.component.ts", lineNumber: 13 });
})();
...
var _c08 = () => ["secondary"];
var _c15 = (a0, a1, a2) => ({ "text-success": a0, "text-danger": a1, "text-secondary": a2 });
var _c24 = (a0, a1) => ({ $implicit: a0, row: a1 });
...
function TblColTemplate_Conditional_0_td_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function TblColTemplate_Conditional_0_td_3_Template_td_click_0_listener($event) {
      const item_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      ctx_r1.lb.copyValue(item_r4.id);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.pageStart + dataIndex_r5, " ");
  }
}
...
function TblColTemplate_Conditional_0_td_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function TblColTemplate_Conditional_0_td_9_Template_td_click_0_listener($event) {
      const item_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      ctx_r1.lb.copyValue(item_r9.status);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction3(2, _c15, item_r9?.status == "Active", item_r9?.status == "DeActive", item_r9.status == "None"));
    \u0275\u0275advance();
...
function TblColTemplate_Conditional_0_th_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 1, "Desc"), " ");
  }
}
function TblColTemplate_Conditional_0_td_12_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("matTooltip", item_r11?.desc);
  }
}
function TblColTemplate_Conditional_0_td_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "td", 28);
    \u0275\u0275listener("click", function TblColTemplate_Conditional_0_td_12_Template_td_click_0_listener($event) {
      const item_r11 = \u0275\u0275restoreView(_r10).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      ctx_r1.lb.copyValue(item_r11.desc);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, TblColTemplate_Conditional_0_td_12_Conditional_2_Template, 2, 1, "span", 31);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r11 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", item_r11?.desc?.slice(0, 50), " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(item_r11?.desc.length > 50 ? 2 : -1);
  }
}
...
function TblColTemplate_Conditional_0_td_15_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", "CreatedAt : " + \u0275\u0275pipeBind2(2, 2, item_r12.createdAt, "dd-MM-yy HH:mm:ss") + " UpdatedAt : " + \u0275\u0275pipeBind2(3, 5, item_r12.updatedAt, "dd-MM-yy HH:mm:ss"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(5, 8, item_r12.updatedAt, "dd-MM-yy"), " ");
  }
}
function TblColTemplate_Conditional_0_th_17_Template(rf, ctx) {
  if (rf & 1) {
...
function TblColTemplate_Conditional_0_td_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 35);
    \u0275\u0275element(1, "tbl-actions-row", 36);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r13 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("record", item_r13);
  }
}
function TblColTemplate_Conditional_0_For_20_th_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 27);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 1, col_r14.name), " ");
  }
}
function TblColTemplate_Conditional_0_For_20_td_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r15 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "td", 28);
    \u0275\u0275listener("click", function TblColTemplate_Conditional_0_For_20_td_2_Template_td_click_0_listener($event) {
      const item_r16 = \u0275\u0275restoreView(_r15).$implicit;
      const col_r14 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      ctx_r1.lb.copyValue(item_r16[col_r14.key]);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const col_r14 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", item_r16[col_r14.key], " ");
  }
}
function TblColTemplate_Conditional_0_For_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0, 17);
    \u0275\u0275template(1, TblColTemplate_Conditional_0_For_20_th_1_Template, 3, 3, "th", 6)(2, TblColTemplate_Conditional_0_For_20_td_2_Template, 2, 1, "td", 7);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const col_r14 = ctx.$implicit;
    \u0275\u0275property("matColumnDef", \u0275\u0275interpolate(col_r14.key));
  }
}
function TblColTemplate_Conditional_0_td_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 37);
    \u0275\u0275elementContainer(1, 38);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngTemplateOutlet", ctx_r1.secondaryTemplate)("ngTemplateOutletContext", \u0275\u0275pureFunction2(3, _c24, item_r17, item_r17));
  }
}
...
function TblColTemplate_Conditional_0_tr_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 40);
  }
  if (rf & 2) {
...
function TblColTemplate_Conditional_0_tr_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 41);
  }
  if (rf & 2) {
...
function TblColTemplate_Conditional_0_tr_26_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 43);
...
function TblColTemplate_Conditional_0_tr_26_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "btn", 47);
    \u0275\u0275listener("clickz", function TblColTemplate_Conditional_0_tr_26_Conditional_4_Template_btn_clickz_6_listener() {
      \u0275\u0275restoreView(_r21);
...
function TblColTemplate_Conditional_0_tr_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "div", 42);
    \u0275\u0275conditionalCreate(3, TblColTemplate_Conditional_0_tr_26_Conditional_3_Template, 5, 0)(4, TblColTemplate_Conditional_0_tr_26_Conditional_4_Template, 7, 0);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function TblColTemplate_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(11, TblColTemplate_Conditional_0_th_11_Template, 3, 3, "th", 9)(12, TblColTemplate_Conditional_0_td_12_Template, 3, 2, "td", 7);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(13, 12);
    \u0275\u0275template(14, TblColTemplate_Conditional_0_th_14_Template, 3, 3, "th", 9)(15, TblColTemplate_Conditional_0_td_15_Template, 6, 11, "td", 13);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(16, 14);
    \u0275\u0275template(17, TblColTemplate_Conditional_0_th_17_Template, 3, 3, "th", 15)(18, TblColTemplate_Conditional_0_td_18_Template, 2, 1, "td", 16);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275repeaterCreate(19, TblColTemplate_Conditional_0_For_20_Template, 3, 2, "ng-container", 17, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementContainerStart(21, 18);
    \u0275\u0275template(22, TblColTemplate_Conditional_0_td_22_Template, 2, 6, "td", 19);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275template(23, TblColTemplate_Conditional_0_tr_23_Template, 1, 0, "tr", 20)(24, TblColTemplate_Conditional_0_tr_24_Template, 1, 2, "tr", 21)(25, TblColTemplate_Conditional_0_tr_25_Template, 1, 4, "tr", 22)(26, TblColTemplate_Conditional_0_tr_26_Template, 5, 2, "tr", 23);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("dataSource", ctx_r1.lb.ds);
    \u0275\u0275advance(19);
    ...
    \u0275\u0275advance();
    \u0275\u0275property("matRowDefColumns", \u0275\u0275pureFunction0(5, _c08));
  }
}
var TblColTemplate = class _TblColTemplate {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TblColTemplate, selectors: [["tbl-col-template"]], hostAttrs: [1, "col"], inputs: { secondaryTemplate: "secondaryTemplate", lb: "lb" }, standalone: false, decls: 1, vars: 1, consts: [["id", "print-area", "mat-table", "", "matSort", "", "multiTemplateDataRows", "", 2, "height", "100%", "box-shadow", "none", 3, "dataSource"], ["id", "print-area", "mat-table", "", "matSort", "", "multiTemplateDataRows", "", 2, "height", "100%", "box-shadow", "none", 3, "matSortChange", "dataSource"], ["matColumnDef", "id"], ["class", "text-nowrap", "mat-header-cell", "", 4, "matHeaderCellDef"], ["class", "text-nowrap", "mat-cell", "", 3, "click", 4, "matCellDef"], ["matColumnDef", "name"], ["class", "text-nowrap text-start", "mat-header-cell", "", "mat-sort-header", "", "arrowPosition", "after", 4, "matHeaderCellDef"], ["class", "text-nowrap text-start", "mat-cell", "", 3, "click", 4, "matCellDef"], ["matColumnDef", "status"], ["class", "text-nowrap", "mat-header-cell", "", "mat-sort-header", "", "arrowPosition", "after", 4, "matHeaderCellDef"], ["mat-cell", "", 3, "ngClass", "click", 4, "matCellDef"], ["matColumnDef", "desc"], ["matColumnDef", "updatedAt"], ["class", "text-nowrap", "mat-cell", "", 4, "matCellDef"], ["matColumnDef", "actions"], ["class", "text-nowrap no-print", "mat-header-cell", "", 4, "matHeaderCellDef"], ["class", "text-nowrap no-print", "mat-cell", "", "matTooltip", "View More Options", "matTooltipPosition", "above", 4, "matCellDef"], [3, "matColumnDef"], ["matColumnDef", "secondary"], ["mat-cell", "", 4, "matCellDef"], ["mat-header-row", "", "class", "bg-dark text-light", 4, "matHeaderRowDef", "matHeaderRowDefSticky"], ["mat-row", "", "matTooltip", "Click Cell To Copy", "matTooltipPosition", "above", "class", "theme-row", 3, "alt-row", 4, "matRowDef", "matRowDefColumns"], ["mat-row", "", 3, "alt-row", "display", 4, "matRowDef", "matRowDefColumns"], [4, "matNoDataRow"], ["mat-header-cell", "", 1, "text-nowrap"], ["mat-cell", "", 1, "text-nowrap", 3, "click"], ["matBadge", "4", "matBadgeOverlap", "false", "matTooltipPosition", "above", "role", "button", 3, "matTooltip"], ["mat-header-cell", "", "mat-sort-header", "", "arrowPosition", "after", 1, "text-nowrap", "text-start"], ["mat-cell", "", 1, "text-nowrap", "text-start", 3, "click"], ["mat-header-cell", "", "mat-sort-header", "", "arrowPosition", "after", 1, "text-nowrap"], ["mat-cell", "", 3, "click", "ngClass"], ["matBadge", "4", "matBadgeOverlap", "false", 1, "badge", "bg-dark", 3, "matTooltip"], ["mat-cell", "", 1, "text-nowrap"], ["matBadge", "4", "matBadgeOverlap", "false", "role", "button", "matTooltipPosition", "above", 3, "matTooltip"], ["mat-header-cell", "", 1, "text-nowrap", "no-print"], ["mat-cell", "", "matTooltip", "View More Options", "matTooltipPosition", "above", 1, "text-nowrap", "no-print"], [3, "record"], ["mat-cell", ""], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], ["mat-header-row", "", 1, "bg-dark", "text-light"], ["mat-row", "", "matTooltip", "Click Cell To Copy", "matTooltipPosition", "above", 1, "theme-row"], ["mat-row", ""], [1, "table-empty-state"], ["diameter", "48", 1, "mb-2"], [1, "mat-headline-small"], [1, "mat-body-medium"], ["color", "primary", 2, "font-size", "25px"], ["lbl", "Refresh", "icon", "refresh", 1, "mt-3", 3, "clickz"]], template: function TblColTemplate_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, TblColTemplate_Conditional_0_Template, 27, 6, "table", 0);
    }
    if (rf & 2) {
      \u0275\u0275conditional(ctx.lb ? 0 : -1);
    }
  }, dependencies: [Btn, NgClass, NgTemplateOutlet, MatIcon, MatTooltip, MatTable, MatHeaderCellDef, MatHeaderRowDef, MatColumnDef, MatCellDef, MatRowDef, MatHeaderCell, MatCell, MatHeaderRow, MatRow, MatNoDataRow, MatSort, MatSortHeader, MatProgressSpinner, TblActionsRow, DatePipe, TranslatePipe], styles: ["\n.cols-wrapper[_ngcontent-%COMP%] {\n  display: flex;\n  flex-wrap: nowrap;\n  align-items: center;\n  gap: 8px;\n}\n.theme-row[_ngcontent-%COMP%]:hover {\n  cursor: pointer;\n  background-color: rgba(121, 121, 121, 0.2666666667);\n}\n  .mat-sort-header-arrow > svg {\n  fill: #fff !important;\n}\n.table-empty-state[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  width: 100%;\n  height: 100%;\n}\n.table-empty-state[_ngcontent-%COMP%]   .mat-headline-small[_ngcontent-%COMP%] {\n  margin: 0;\n}\n.table-empty-state[_ngcontent-%COMP%]   .mat-body-medium[_ngcontent-%COMP%] {\n  color: var(--mat-sys-on-surface-variant);\n  max-width: 320px;\n}\n.table-empty-state[_ngcontent-%COMP%]   button[_ngcontent-%COMP%] {\n  margin-top: 8px;\n}\n  .mat-mdc-menu-item {\n  min-height: 40px;\n}\n.alt-row[_ngcontent-%COMP%] {\n  background-color: rgba(195, 195, 195, 0.1882352941);\n}\n.theme-row[_ngcontent-%COMP%]:hover {\n  background-color: rgba(135, 134, 134, 0.1882352941);\n}\n/*# sourceMappingURL=tbl-col-template-EQEID56Y.css.map */"] });
};
(() => {
...
<table id="print-area" mat-table matSort [dataSource]="lb.ds" multiTemplateDataRows style="height: 100%;box-shadow: none;"\r
  (matSortChange)="lb.sort($event)">\r
  <ng-container matColumnDef="id">\r
    <th class="text-nowrap" mat-header-cell *matHeaderCellDef>\r
      {{ 'S. No' | translate }}\r
    </th>\r
    <td class="text-nowrap" mat-cell *matCellDef="let item; let dataIndex = dataIndex"\r
  ...
  <ng-container matColumnDef="status">\r
    ...
    <td mat-cell *matCellDef="let item"\r
      ...
      (click)="lb.copyValue(item.status); $event.stopPropagation();">\r
      {{item?.status}}\r
    </td>\r
  </ng-container>\r
...
\r
  ...
  <ng-container matColumnDef="actions">\r
    <th class="text-nowrap no-print" mat-header-cell *matHeaderCellDef>\r
      {{'Actions' | translate}}\r
    </th>\r
    <td class="text-nowrap no-print" mat-cell *matCellDef="let item" matTooltip="View More Options" matTooltipPosition="above">\r
  ...
  <ng-container matColumnDef="secondary">\r
    <td mat-cell [attr.colspan]="lb?.cols?.length || 1" *matCellDef="let item">\r
    <ng-container\r
...
function TblActions_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
...
function TblActions_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "button", 2)(1, "mat-icon");
    \u0275\u0275text(2, "more_vert");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
var TblActions = class _TblActions {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TblActions, selectors: [["tbl-actions"]], standalone: false, decls: 24, vars: 1, consts: [["menu", "matMenu"], ["mat-raised-button", "", "color", "primary", "type", "button", "type", "button", 1, "me-2", 3, "matMenuTriggerFor"], ["mat-mini-fab", "", "type", "button", 1, "me-2", 3, "matMenuTriggerFor"], ["type", "button"], ["mat-menu-item", "", "type", "button", 3, "click"], [1, "me-2"]], template: function TblActions_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, TblActions_Conditional_0_Template, 6, 4, "button", 1)(1, TblActions_Conditional_1_Template, 3, 1, "button", 2);
      \u0275\u0275elementStart(2, "mat-menu", 3, 0)(4, "button", 4);
      \u0275\u0275listener("click", function TblActions_Template_button_click_4_listener() {
      ...
      \u0275\u0275text(8, "Download CSV");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(9, "button", 4);
      \u0275\u0275listener("click", function TblActions_Template_button_click_9_listener() {
      ...
      \u0275\u0275text(13, "Download JSON");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(14, "button", 4);
      \u0275\u0275listener("click", function TblActions_Template_button_click_14_listener() {
        return ctx._template.lb.copyListJSON();
      });
      \u0275\u0275elementStart(15, "mat-icon", 5);
      ...
      \u0275\u0275listener("click", function TblActions_Template_button_click_19_listener() {
        return ctx._template.lb.printList();
      });
      \u0275\u0275elementStart(20, "mat-icon", 5);
      \u0275\u0275text(21, "print");
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      \u0275\u0275conditional(ctx._template?.LG ? 0 : !ctx._template?.LG ? 1 : -1);
    }
