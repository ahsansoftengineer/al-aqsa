...
function TblPaginatorComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("length", ctx_r1.lb?.httpResPaginate?.count)("pageIndex", ctx_r1.lb.httpReqPaginate?.body?.pageNo - 1)("pageSize", ctx_r1.lb?.httpReqPaginate?.body?.pageSize)("pageSizeOptions", \u0275\u0275pureFunction0(4, _c05));
  }
}
...
var TblActionsRow = class _TblActionsRow {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TblActionsRow, selectors: [["tbl-actions-row"]], inputs: { record: "record" }, standalone: false, decls: 41, vars: 16, consts: [["menu", "matMenu"], ["mat-icon-button", "", "type", "button", 2, "height", "35px", "overflow", "visible", 3, "matMenuTriggerFor"], [1, "text-primary"], ["type", "button"], ["mat-menu-item", "", "type", "button", 3, "click"], [1, "me-2"], ["mat-menu-item", "", "color", "primary", 1, "me-1", 3, "routerLink"], [1, "me-2", 3, "ngClass"], [3, "ngClass"], [1, "me-2", "text-danger"], [1, "text-danger"]], template: function TblActionsRow_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("routerLink", \u0275\u0275pureFunction2(13, _c06, ctx._template.linkUpdate, ctx.record?.id));
      \u0275\u0275advance(4);
...
var _c07 = () => ["secondary"];
var _c14 = (a0, a1, a2) => ({ "text-success": a0, "text-danger": a1, "text-secondary": a2 });
var _c23 = (a0, a1) => ({ $implicit: a0, row: a1 });
...
function TblColTemplate_Conditional_0_td_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction3(2, _c14, item_r9?.status == "Active", item_r9?.status == "DeActive", item_r9.status == "None"));
    \u0275\u0275advance();
...
function TblColTemplate_Conditional_0_td_22_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngTemplateOutlet", ctx_r1.secondaryTemplate)("ngTemplateOutletContext", \u0275\u0275pureFunction2(3, _c23, item_r17, item_r17));
  }
}
...
function TblColTemplate_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("matRowDefColumns", \u0275\u0275pureFunction0(8, _c07));
  }
}
var TblColTemplate = class _TblColTemplate {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TblColTemplate, selectors: [["tbl-col-template"]], hostAttrs: [1, "col"], inputs: { secondaryTemplate: "secondaryTemplate", lb: "lb" }, standalone: false, decls: 1, vars: 1, consts: [["id", "print-area", "mat-table", "", "matSort", "", "multiTemplateDataRows", "", 2, "height", "100%", "box-shadow", "none", 3, "dataSource"], ["id", "print-area", "mat-table", "", "matSort", "", "multiTemplateDataRows", "", 2, "height", "100%", "box-shadow", "none", 3, "matSortChange", "dataSource"], ["matColumnDef", "id", 3, "sticky"], ["class", "text-nowrap", "mat-header-cell", "", 4, "matHeaderCellDef"], ["class", "text-nowrap text-center", "mat-cell", "", 3, "click", 4, "matCellDef"], ["matColumnDef", "name", 3, "sticky"], ["class", "text-nowrap text-start", "mat-header-cell", "", "mat-sort-header", "", "arrowPosition", "after", 4, "matHeaderCellDef"], ["class", "text-nowrap text-start", "mat-cell", "", 3, "click", 4, "matCellDef"], ["matColumnDef", "status"], ["class", "text-nowrap", "mat-header-cell", "", "mat-sort-header", "", "arrowPosition", "after", 4, "matHeaderCellDef"], ["mat-cell", "", 3, "ngClass", "click", 4, "matCellDef"], ["matColumnDef", "desc"], ["matColumnDef", "updatedAt"], ["class", "text-nowrap", "mat-cell", "", 4, "matCellDef"], ["matColumnDef", "actions", 3, "stickyEnd"], ["class", "text-nowrap no-print text-center", "mat-header-cell", "", 4, "matHeaderCellDef"], ["class", "text-nowrap no-print text-center", "mat-cell", "", "matTooltip", "View More Options", "matTooltipPosition", "above", 4, "matCellDef"], [3, "matColumnDef"], ["matColumnDef", "secondary"], ["mat-cell", "", 4, "matCellDef"], ["mat-header-row", "", "class", "bg-dark text-light", 4, "matHeaderRowDef", "matHeaderRowDefSticky"], ["mat-row", "", "matTooltip", "Click Cell To Copy", "matTooltipPosition", "above", "class", "theme-row", 3, "alt-row", 4, "matRowDef", "matRowDefColumns"], ["mat-row", "", 3, "alt-row", "display", 4, "matRowDef", "matRowDefColumns"], [4, "matNoDataRow"], ["mat-header-cell", "", 1, "text-nowrap"], ["mat-cell", "", 1, "text-nowrap", "text-center", 3, "click"], ["matBadge", "4", "matBadgeOverlap", "false", "matTooltipPosition", "above", "role", "button", 3, "matTooltip"], ["mat-header-cell", "", "mat-sort-header", "", "arrowPosition", "after", 1, "text-nowrap", "text-start"], ["mat-cell", "", 1, "text-nowrap", "text-start", 3, "click"], ["mat-header-cell", "", "mat-sort-header", "", "arrowPosition", "after", 1, "text-nowrap"], ["mat-cell", "", 3, "click", "ngClass"], ["matBadge", "4", "matBadgeOverlap", "false", 1, "badge", "bg-dark", 3, "matTooltip"], ["mat-cell", "", 1, "text-nowrap"], ["matBadge", "4", "matBadgeOverlap", "false", "role", "button", "matTooltipPosition", "above", 3, "matTooltip"], ["mat-header-cell", "", 1, "text-nowrap", "no-print", "text-center"], ["mat-cell", "", "matTooltip", "View More Options", "matTooltipPosition", "above", 1, "text-nowrap", "no-print", "text-center"], [3, "record"], ["mat-cell", ""], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], ["mat-header-row", "", 1, "bg-dark", "text-light"], ["mat-row", "", "matTooltip", "Click Cell To Copy", "matTooltipPosition", "above", 1, "theme-row"], ["mat-row", ""], [1, "table-empty-state"], ["diameter", "48", 1, "mb-2"], [1, "mat-headline-small"], [1, "mat-body-medium"], ["color", "primary", 2, "font-size", "25px"], ["lbl", "Refresh", "icon", "refresh", 1, "mt-3", 3, "clickz"]], template: function TblColTemplate_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, TblColTemplate_Conditional_0_Template, 27, 9, "table", 0);
    }
    if (rf & 2) {
...
//# sourceMappingURL=chunk-QH75GOSB.js.map
