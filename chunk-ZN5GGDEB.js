...
var AdminAdd = class _AdminAdd extends BaseClassTemplate {
  ...
  static \u0275fac = function AdminAdd_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AdminAdd)(\u0275\u0275directiveInject(ActivatedRoute));
  };
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminAdd, { className: "AdminAdd", filePath: "app/feature/userz/admin/admin-add/admin-add.ts", lineNumber: 18 });
})();
...
var Student = class _Student extends BaseClassTemplate {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Student, selectors: [["aam-student"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 3, vars: 2, consts: [["secondaryTpl", ""], [3, "lb", "secondaryTemplate"]], template: function Student_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275template(0, Student_ng_template_0_Template, 1, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
...
var StudentAdd = class _StudentAdd extends BaseClassTemplate {
  ...
  static \u0275fac = function StudentAdd_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _StudentAdd)(\u0275\u0275directiveInject(ActivatedRoute));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StudentAdd, selectors: [["aam-student-add"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 4, vars: 10, consts: [["studentSpecific", ""], [3, "ctrl", "listz"]], template: function StudentAdd_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StudentAdd, { className: "StudentAdd", filePath: "app/feature/userz/student/student-add/student-add.ts", lineNumber: 18 });
})();
...
var TeacherAdd = class _TeacherAdd extends BaseClassTemplate {
  ...
  static \u0275fac = function TeacherAdd_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _TeacherAdd)(\u0275\u0275directiveInject(ActivatedRoute));
  };
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TeacherAdd, { className: "TeacherAdd", filePath: "app/feature/userz/teacher/teacher-add/teacher-add.ts", lineNumber: 17 });
})();
...
var ParentAdd = class _ParentAdd extends BaseClassTemplate {
  ...
  static \u0275fac = function ParentAdd_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ParentAdd)(\u0275\u0275directiveInject(ActivatedRoute));
  };
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParentAdd, { className: "ParentAdd", filePath: "app/feature/userz/parent/parent-add/parents-add.ts", lineNumber: 17 });
})();
...
//# sourceMappingURL=chunk-ZN5GGDEB.js.map
