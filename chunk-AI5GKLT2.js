import {
  MatzThemeModule
} from "./chunk-HT7MA6BB.js";
import "./chunk-CMIFOH57.js";
import {
  MatGridList,
  MatGridTile
...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "user",
        loadChildren: () => import("./chunk-JNLLJKX4.js").then((m) => m.UserzModule)
      },
      {
        path: "edu",
        loadChildren: () => import("./chunk-UMXH2JUK.js").then((m) => m.EduModule)
      },
      {
        path: "syllabus",
        loadChildren: () => import("./chunk-LMTUQQGY.js").then((m) => m.EduSyllabusModule)
      },
      {
        path: "attendance",
        loadChildren: () => import("./chunk-OAI26MFO.js").then((m) => m.AttendanceModule)
      },
      {
        path: "question-bank",
        loadChildren: () => import("./chunk-7SXNTAHP.js").then((m) => m.EduQuestionModule)
      },
      {
        path: "exam",
        loadChildren: () => import("./chunk-CDY3JCB5.js").then((m) => m.EduExamModule)
      },
      {
        path: "library",
        loadChildren: () => import("./chunk-JWFHFAUR.js").then((m) => m.EduLibraryModule)
      },
      {
        path: "account-in",
      ...
      {
        path: "file-upload",
        loadChildren: () => import("./chunk-MMWPDKP7.js").then((m) => m.FileUploadModule)
      },
      {
        path: "notification",
...
//# sourceMappingURL=chunk-AI5GKLT2.js.map
