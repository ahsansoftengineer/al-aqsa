...
import {
  MenuModuleIndex
} from "./chunk-EDMH3MKX.js";
import {
  MenuSimpleIndex
} from "./chunk-DEDXK7R5.js";
import {
...
function SideBarMatListItemComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 3)(1, "mat-icon", 6);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function SideBarMatListItemComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function SideBarMatListItemComponent_Conditional_7_Template_div_click_0_listener($event) {
      return $event.stopPropagation();
    });
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", ctx_r0.item?.link + "-add");
  }
}
function SideBarMatListItemComponent_Conditional_8_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 0)(1, "mat-icon", 8);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", it_r2.link);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 5, it_r2?.title), " ");
  }
}
function SideBarMatListItemComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5);
    \u0275\u0275repeaterCreate(1, SideBarMatListItemComponent_Conditional_8_For_2_Template, 6, 7, "a", 0, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var SideBarMatListItemComponent = class _SideBarMatListItemComponent extends BaseClassSrvc {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SideBarMatListItemComponent, selectors: [["theme-side-bar-mat-list-item"]], inputs: { item: "item" }, standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 9, vars: 8, consts: [["mat-list-item", "", 1, "mb-1", "p-0", 3, "routerLink", "activated"], ["matListItemIcon", "", 1, "mx-1"], ["matListItemTitle", ""], ["matListItemMeta", ""], ["matListItemMeta", "", 3, "routerLink"], [1, "mb-2", 2, "background-color", "rgba(0, 0, 0, 0.05)"], [1, "m-0", "ms-1"], ["matListItemMeta", "", 3, "click", "routerLink"], ["matListItemIcon", "", 1, "mx-1", "ms-2"], ["matListItemTitle", "", 3, "routerLink"]], template: function SideBarMatListItemComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(5, "titlecase");
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(6, SideBarMatListItemComponent_Conditional_6_Template, 3, 1, "div", 3)(7, SideBarMatListItemComponent_Conditional_7_Template, 3, 1, "div", 4);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(8, SideBarMatListItemComponent_Conditional_8_Template, 3, 3, "div", 5);
    }
    if (rf & 2) {
      ...
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.item?.submenu?.length ? 6 : 7);
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.item?.isActive ? 8 : -1);
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SideBarMatListItemComponent, [{
    ...
    args: [{ standalone: false, encapsulation: ViewEncapsulation.None, changeDetection: ChangeDetectionStrategy.Eager, selector: "theme-side-bar-mat-list-item", animations: [
      ...
      fadeInDownOnEnterAnimation(),
      fadeOutUpOnLeaveAnimation()
    ], template: `<a mat-list-item [routerLink]="item?.link" [activated]="item?.isActive" class="mb-1 p-0">\r
  <mat-icon matListItemIcon class="mx-1">\r
    {{ item?.icon }}\r
  </mat-icon>\r
\r
...
\r
  @if (item?.submenu?.length) {\r
    ...
    <div matListItemMeta [routerLink]="item?.link + '-add'" (click)=" $event.stopPropagation();">\r
      <mat-icon class="m-0 ms-1">add</mat-icon>\r
    </div>\r
  }\r
</a>\r
\r
@if (item?.isActive) {\r
<div [@slideOutLeftOnLeave] [@slideInLeftOnEnter] class="mb-2" style="background-color: rgba(0, 0, 0, 0.05);">\r
  @for (it of item?.submenu ?? []; track it.link) {\r
    <a mat-list-item [routerLink]="it.link" [activated]="it?.isActive" class="mb-1 p-0">\r
      <mat-icon matListItemIcon  class="mx-1 ms-2">\r
        {{ it?.icon || 'blur_circular' }}\r
      </mat-icon>\r
      <span matListItemTitle [routerLink]="it.link">\r
        {{ it?.title | titlecase }}\r
      </span>\r
      <!-- <div matListItemMeta [routerLink]="it?.link + '-add'" (click)="$event.stopPropagation();">\r
        <mat-icon class="m-0 ms-1 mt-1 p-3 ps-0 "\r
         style="font-size: 20px; color: orange; text-align: center; height: 100%;">add</mat-icon>\r
      </div> -->\r
    </a>\r
\r
  }\r
...
var routes = [
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-2CRLWTNU.js").then((m) => m.FeatureAuthModule)
  },
  {
    path: "",
    ...
    children: [
      {
        path: "dashboard",
        loadChildren: () => import("./chunk-4JIHBPC7.js").then((m) => m.FeatureDashboardModule)
      },
      {
        path: "feature",
        loadChildren: () => import("./chunk-AI5GKLT2.js").then((m) => m.FeatureModule)
      },
      {
        path: "print",
        loadChildren: () => import("./chunk-YK3AXMIT.js").then((m) => m.FeaturePrintModule)
      },
...
var AppComponent = class _AppComponent extends BaseClassFuncs {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: false, features: [\u0275\u0275ProvidersFeature([ProviderService]), \u0275\u0275InheritDefinitionFeature], decls: 3, vars: 0, consts: [[2, "position", "fixed"]], template: function AppComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275element(0, "ctrl-loader")(1, "notify-container", 0)(2, "router-outlet");
    }
...
\u0275\u0275setComponentScope(MenuSimpleIndex, [MatCardActions, MatCardContent, MenuIndexComponent], [TranslatePipe]);
...
//# sourceMappingURL=main-N2PN4WHM.js.map
