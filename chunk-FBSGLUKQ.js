...
// src/_shared/table/tbl-actions/tbl-actions.component.ts
var _c06 = (a0) => [a0];
var TblActionsComponent = class _TblActionsComponent {
  _template;
  record;
  ...
  static \u0275fac = function TblActionsComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _TblActionsComponent)(\u0275\u0275directiveInject(TemplateService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TblActionsComponent, selectors: [["tbl-actions"]], inputs: { record: "record" }, standalone: false, decls: 36, vars: 13, consts: [["menu", "matMenu"], ["mat-icon-button", "", "type", "button", 2, "height", "35px", "overflow", "visible", 3, "matMenuTriggerFor"], [1, "text-primary"], ["type", "button"], ["mat-menu-item", "", "color", "primary", 1, "me-1", 3, "routerLink"], [1, "me-2"], ["mat-menu-item", "", "type", "button", 3, "click"], [1, "me-2", 3, "ngClass"], [3, "ngClass"], [1, "me-2", "text-danger"], [1, "text-danger"]], template: function TblActionsComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "button", 1)(1, "mat-icon", 2);
      \u0275\u0275text(2, "more_vert");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(3, "mat-menu", 3, 0)(5, "a", 4)(6, "mat-icon", 5);
      \u0275\u0275text(7, "edit");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275listener("click", function TblActionsComponent_Template_button_click_11_listener() {
      ...
      \u0275\u0275listener("click", function TblActionsComponent_Template_button_click_16_listener() {
      ...
      \u0275\u0275text(20, "Export to CSV");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(21, "button", 6);
      \u0275\u0275listener("click", function TblActionsComponent_Template_button_click_21_listener() {
        return ctx._template.lb.updateStatus(ctx.record);
      });
      \u0275\u0275elementStart(22, "mat-icon", 7);
      \u0275\u0275text(23);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275listener("click", function TblActionsComponent_Template_button_click_26_listener() {
        return ctx._template.lb.updateDelete(ctx.record);
      });
      \u0275\u0275elementStart(27, "mat-icon", 9);
      \u0275\u0275text(28, "delete");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(29, "span", 10);
      \u0275\u0275text(30, "Delete Soft");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(31, "button", 6);
      \u0275\u0275listener("click", function TblActionsComponent_Template_button_click_31_listener() {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(5);
      \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(11, _c06, ctx._template.linkUpdate + ctx.record?.id));
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(10, 9, "Edit"));
      \u0275\u0275advance(13);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TblActionsComponent, [{
    type: Component,
    args: [{ standalone: false, encapsulation: ViewEncapsulation.None, changeDetection: ChangeDetectionStrategy.OnPush, selector: "tbl-actions", template: `<!--\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TblActionsComponent, { className: "TblActionsComponent", filePath: "_shared/table/tbl-actions/tbl-actions.component.ts", lineNumber: 13 });
})();

// src/_shared/table/tbl-paginator/tbl-paginator.component.ts
var _c07 = () => [10, 20, 25, 50, 100, 200, 250, 500, 1e3];
function TblPaginatorComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("length", ctx_r1.lb?.httpResPaginate?.count)("pageIndex", ctx_r1.lb.httpReqPaginate?.body?.pageNo - 1)("pageSize", ctx_r1.lb?.httpReqPaginate?.body?.pageSize)("pageSizeOptions", \u0275\u0275pureFunction0(4, _c07));
  }
}
...
var _c08 = (a0, a1, a2) => ({ "text-success": a0, "text-danger": a1, "text-secondary": a2 });
...
function TblColTemplate_Conditional_0_td_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.pageStart + i_r5, " ");
  }
}
...
function TblColTemplate_Conditional_0_td_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction3(2, _c08, item_r9?.status == "Active", item_r9?.status == "DeActive", item_r9.status == "None"));
    \u0275\u0275advance();
...
function TblColTemplate_Conditional_0_td_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, TblColTemplate_Conditional_0_td_12_Conditional_2_Template, 2, 1, "span", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function TblColTemplate_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(21, TblColTemplate_Conditional_0_tr_21_Template, 1, 0, "tr", 18)(22, TblColTemplate_Conditional_0_tr_22_Template, 1, 0, "tr", 19);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var TblColTemplate = class _TblColTemplate {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TblColTemplate, selectors: [["tbl-col-template"]], hostAttrs: [1, "col"], inputs: { lb: "lb" }, standalone: false, decls: 1, vars: 1, consts: [["id", "print-area", "mat-table", "", "matSort", "", 2, "box-shadow", "none", 3, "dataSource"], ["id", "print-area", "mat-table", "", "matSort", "", 2, "box-shadow", "none", 3, "matSortChange", "dataSource"], ["matColumnDef", "id"], ["class", "text-nowrap", "mat-header-cell", "", 4, "matHeaderCellDef"], ["class", "text-nowrap", "mat-cell", "", 3, "click", 4, "matCellDef"], ["matColumnDef", "name"], ["class", "text-nowrap text-start", "mat-header-cell", "", "mat-sort-header", "", "arrowPosition", "after", 4, "matHeaderCellDef"], ["class", "text-nowrap text-start", "mat-cell", "", 3, "click", 4, "matCellDef"], ["matColumnDef", "status"], ["class", "text-nowrap", "mat-header-cell", "", "mat-sort-header", "", "arrowPosition", "after", 4, "matHeaderCellDef"], ["mat-cell", "", 3, "ngClass", "click", 4, "matCellDef"], ["matColumnDef", "desc"], ["matColumnDef", "updatedAt"], ["class", "text-nowrap", "mat-cell", "", 4, "matCellDef"], ["matColumnDef", "actions"], ["class", "text-nowrap no-print", "mat-header-cell", "", 4, "matHeaderCellDef"], ["class", "text-nowrap no-print", "mat-cell", "", "matTooltip", "View More Options", "matTooltipPosition", "above", 4, "matCellDef"], [3, "matColumnDef"], ["mat-header-row", "", "class", "bg-dark text-light", 4, "matHeaderRowDef", "matHeaderRowDefSticky"], ["matTooltip", "Click Cell To Copy", "matTooltipPosition", "above", "mat-row", "", "class", "theme-row", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", "", 1, "text-nowrap"], ["mat-cell", "", 1, "text-nowrap", 3, "click"], ["matBadge", "4", "matBadgeOverlap", "false", "matTooltipPosition", "above", "role", "button", 3, "matTooltip"], ["mat-header-cell", "", "mat-sort-header", "", "arrowPosition", "after", 1, "text-nowrap", "text-start"], ["mat-cell", "", 1, "text-nowrap", "text-start", 3, "click"], ["mat-header-cell", "", "mat-sort-header", "", "arrowPosition", "after", 1, "text-nowrap"], ["mat-cell", "", 3, "click", "ngClass"], ["matBadge", "4", "matBadgeOverlap", "false", 1, "badge", "bg-dark", 3, "matTooltip"], ["mat-cell", "", 1, "text-nowrap"], ["matBadge", "4", "matBadgeOverlap", "false", "role", "button", "matTooltipPosition", "above", 3, "matTooltip"], ["mat-header-cell", "", 1, "text-nowrap", "no-print"], ["mat-cell", "", "matTooltip", "View More Options", "matTooltipPosition", "above", 1, "text-nowrap", "no-print"], [3, "record"], ["mat-header-row", "", 1, "bg-dark", "text-light"], ["matTooltip", "Click Cell To Copy", "matTooltipPosition", "above", "mat-row", "", 1, "theme-row"]], template: function TblColTemplate_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, TblColTemplate_Conditional_0_Template, 23, 4, "table", 0);
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TblColTemplate, [{
    type: Component,
    args: [{ selector: "tbl-col-template", standalone: false, host: { class: "col" }, template: `@if (lb?.ds) {\r
<table id="print-area" mat-table matSort [dataSource]="lb.ds" style="box-shadow: none;"\r
  (matSortChange)="lb.sort($event)">\r
  <ng-container matColumnDef="id">\r
    <th class="text-nowrap" mat-header-cell *matHeaderCellDef>\r
      {{ 'S. No' | translate }}\r
    </th>\r
    <td class="text-nowrap" mat-cell *matCellDef="let item; let i = index"\r
...
\r
  ...
  <ng-container matColumnDef="actions">\r
    ...
    <td class="text-nowrap no-print" mat-cell *matCellDef="let item" matTooltip="View More Options"\r
  ...
  <tr matTooltip="Click Cell To Copy" matTooltipPosition="above" mat-row *matRowDef="let row; columns: lb.cols;"\r
    class="theme-row"></tr>\r
</table>\r
}\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TblColTemplate, { className: "TblColTemplate", filePath: "_shared/table/tbl-col-template/tbl-col-template.ts", lineNumber: 25 });
})();
