...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TblPaginatorComponent, { className: "TblPaginatorComponent", filePath: "_shared/table/tbl-paginator/tbl-paginator.ts", lineNumber: 13 });
})();
...
function TblColTemplate_Conditional_0_td_22_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngTemplateOutlet", ctx_r1.secondaryTemplate)("ngTemplateOutletContext", \u0275\u0275pureFunction2(3, _c33, item_r17, item_r17));
  }
}
...
function TblColTemplate_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("dataSource", ctx_r1.lb.ds)("ngStyle", !ctx_r1.lb?.ds?.data?.length ? \u0275\u0275pureFunction0(9, _c07) : null);
    \u0275\u0275advance();
...
//# sourceMappingURL=chunk-ZDXZVHP6.js.map
