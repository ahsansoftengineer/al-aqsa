...
function ZTemplateFeature_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "btn-link", 12);
    \u0275\u0275elementStart(2, "btn", 13);
...
function ZTemplateFeature_Conditional_13_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "btn", 15);
    \u0275\u0275listener("clickz", function ZTemplateFeature_Conditional_13_Conditional_1_Template_btn_clickz_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0._template.tmSubmit.resetForm());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(1, "btn", 16);
    \u0275\u0275listener("clickz", function ZTemplateFeature_Conditional_13_Conditional_1_Template_btn_clickz_1_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0._template.tmSubmit.submit());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275element(2, "btn-link", 17);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
...
function ZTemplateFeature_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-card-actions", 11);
    \u0275\u0275conditionalCreate(1, ZTemplateFeature_Conditional_13_Conditional_1_Template, 3, 1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0._template.tmSubmit ? 1 : -1);
  }
}
function ZTemplateFeature_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-card-actions", 11);
    \u0275\u0275element(1, "tbl-paginator", 18);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var ZTemplateFeature = class _ZTemplateFeature extends BaseClassTemplate {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ZTemplateFeature, selectors: [["aam-feature"]], standalone: false, features: [\u0275\u0275InheritDefinitionFeature], decls: 15, vars: 5, consts: [[1, "dashboard-card", "p-0", "m-1"], [1, "dashboard-card-content", "p-1"], ["cols", "12", "rowHeight", "55px", 1, "mb-2"], [1, "flex--start", 3, "colspan"], [1, "m-0", "mt-1", "fs-5"], [1, "flex--end", 2, "overflow", "visible", 3, "colspan"], ["cols", "1", 3, "rowHeight"], ["colspan", "1"], [1, "m-1", "mx-0", 2, "width", "100%", "height", "100%", "overflow-x", "auto"], ["cols", "1", "rowHeight", "60px", 1, "mt-2"], ["colspan", "1", 1, "flex--end"], ["align", "end"], ["lbl", "Add", "icon", "local_hospital", 3, "link"], ["lbl", "Refresh", "icon", "autorenew", 3, "clickz"], ["lbl", "Filter", 3, "clickz", "icon"], ["lbl", "Reset", "icon", "cached", 3, "clickz"], ["lbl", "Save", "icon", "save", 3, "clickz"], ["lbl", "Cancel", "icon", "cancel", 3, "link"], [3, "lb"]], template: function ZTemplateFeature_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(11, "mat-grid-list", 9)(12, "mat-grid-tile", 10);
      \u0275\u0275conditionalCreate(13, ZTemplateFeature_Conditional_13_Template, 2, 1, "mat-card-actions", 11)(14, ZTemplateFeature_Conditional_14_Template, 2, 1, "mat-card-actions", 11);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
      ...
      \u0275\u0275advance(6);
      \u0275\u0275conditional(ctx._template?.linkPaginate ? 13 : ctx._template.linkAdd ? 14 : -1);
    }
...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "user",
        loadChildren: () => import("./chunk-ZN5GGDEB.js").then((m) => m.UserzModule)
      },
      {
        path: "account-in",
        loadChildren: () => import("./chunk-PSVV5PVZ.js").then((m) => m.AccountInModule)
      },
      {
        path: "account-out",
        loadChildren: () => import("./chunk-OAZNKAGN.js").then((m) => m.AccountOutModule)
      },
      {
        path: "edu",
        loadChildren: () => import("./chunk-XSMXSGYG.js").then((m) => m.EduModule)
      },
      {
        path: "library",
        loadChildren: () => import("./chunk-VSP47EJU.js").then((m) => m.EduLibraryModule)
      },
      {
        path: "exam",
        loadChildren: () => import("./chunk-VD6KPKHH.js").then((m) => m.EduExamModule)
      },
      {
        path: "syllabus",
        loadChildren: () => import("./chunk-EXTIL25N.js").then((m) => m.EduSyllabusModule)
      },
      {
        path: "question-bank",
        loadChildren: () => import("./chunk-GPQAAGYU.js").then((m) => m.EduQuestionModule)
      },
      {
        path: "file-upload",
        loadChildren: () => import("./chunk-AQQKK7Z7.js").then((m) => m.FileUploadModule)
      },
      {
        path: "notification",
        loadChildren: () => import("./chunk-MQBWIHFO.js").then((m) => m.NotificationModule)
      }
    ]
  }
];
...
//# sourceMappingURL=chunk-A3TDQXY5.js.map
