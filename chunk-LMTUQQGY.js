...
var BookAdd = class _BookAdd extends BaseClassTemplate {
  ...
  static \u0275fac = /* @__PURE__ */ (() => {
    let \u0275BookAdd_BaseFactory;
    return function BookAdd_Factory(__ngFactoryType__) {
      return (\u0275BookAdd_BaseFactory || (\u0275BookAdd_BaseFactory = \u0275\u0275getInheritedFactory(_BookAdd)))(__ngFactoryType__ || _BookAdd);
    };
  })();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookAdd, { className: "BookAdd", filePath: "app/feature/edu-syllabus/book/book-add/book-add.ts", lineNumber: 17 });
})();
...
var ChapterAdd = class _ChapterAdd extends BaseClassTemplate {
  ...
  static \u0275fac = /* @__PURE__ */ (() => {
    let \u0275ChapterAdd_BaseFactory;
    return function ChapterAdd_Factory(__ngFactoryType__) {
      return (\u0275ChapterAdd_BaseFactory || (\u0275ChapterAdd_BaseFactory = \u0275\u0275getInheritedFactory(_ChapterAdd)))(__ngFactoryType__ || _ChapterAdd);
    };
  })();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ChapterAdd, { className: "ChapterAdd", filePath: "app/feature/edu-syllabus/chapter/chapter-add/chapter-add.ts", lineNumber: 17 });
})();
...
var SubjectzAdd = class _SubjectzAdd extends BaseClassTemplate {
  ...
  static \u0275fac = /* @__PURE__ */ (() => {
    let \u0275SubjectzAdd_BaseFactory;
    return function SubjectzAdd_Factory(__ngFactoryType__) {
      return (\u0275SubjectzAdd_BaseFactory || (\u0275SubjectzAdd_BaseFactory = \u0275\u0275getInheritedFactory(_SubjectzAdd)))(__ngFactoryType__ || _SubjectzAdd);
    };
  })();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SubjectzAdd, { className: "SubjectzAdd", filePath: "app/feature/edu-syllabus/subjectz/subjectz-add/subjectz-add.ts", lineNumber: 17 });
})();
...
//# sourceMappingURL=chunk-LMTUQQGY.js.map
