...
var ROUTEZ = [
  ...
  P("Prints", "receipt", "\u{1F5A8}\uFE0F", "/print", "Printable Forms, Summary and Reports", [
    C("Form Admission", "article", "\u{1F4C4}", "form-admission"),
    C("Form Explation", "article", "\u{1F4CA}", "form-explanation"),
    C("Form Leave", "article", "\u{1F4C3}", "form-leave"),
    C("Report Attendace", "article", "\u{1F4DD}", "report-attendance"),
...
//# sourceMappingURL=chunk-EA5SXDL7.js.map
