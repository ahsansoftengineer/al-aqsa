...
<mat-sidenav-container [hasBackdrop]="sideNav?.Left?.mode == 'over'"\r
  ...
  <mat-sidenav\r
    ...
    [fixedTopGap]="60"\r
    class="theme-sidenav-left p-0 p-md-1">\r
    <theme-side-nav-left></theme-side-nav-left>\r
  </mat-sidenav>\r
  ...
  <mat-sidenav\r
    ...
    [fixedInViewport]="true"\r
    [fixedTopGap]="60"\r
    class="theme-sidenav-right p-0 p-md-1 ">\r
    <theme-side-nav-right></theme-side-nav-right>\r
  </mat-sidenav>\r
\r
