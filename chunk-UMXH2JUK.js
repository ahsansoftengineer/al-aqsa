...
var Routez = new RoutezFeatureModule("Education", "feature/edu").feature(Institute, InstituteAdd, "institute", "Institute").feature(Classz, ClasszAdd, "class", "Class").feature(Sectionz, SectionzAdd, "section", "Section").feature(ClassSection, ClassSectionAdd, "class-section", "Class Section").feature(ClassRoutine, ClassRoutineAdd, "class-routine", "Class Routine").feature(StudentPromote, StudentPromoteAdd, "student-promote", "Student Promote").build();
...
//# sourceMappingURL=chunk-UMXH2JUK.js.map
