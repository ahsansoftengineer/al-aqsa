...
var ClassRoutineAdd = class _ClassRoutineAdd extends BaseClassTemplate {
  ...
  static \u0275fac = function ClassRoutineAdd_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ClassRoutineAdd)(\u0275\u0275directiveInject(ActivatedRoute));
  };
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ClassRoutineAdd, { className: "ClassRoutineAdd", filePath: "app/feature/edu/class-routine/class-routine-add/class-routine-add.ts", lineNumber: 13 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ClasszAdd, { className: "ClasszAdd", filePath: "app/feature/edu/classz/classz-add/classz-add.ts", lineNumber: 18 });
})();
...
var InstituteAdd = class _InstituteAdd extends BaseClassTemplate {
  ...
  static \u0275fac = function InstituteAdd_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _InstituteAdd)(\u0275\u0275directiveInject(ActivatedRoute));
  };
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InstituteAdd, { className: "InstituteAdd", filePath: "app/feature/edu/institute/institute-add/institute-add.ts", lineNumber: 18 });
})();
...
var StudentPromoteAdd = class _StudentPromoteAdd extends BaseClassTemplate {
  ...
  static \u0275fac = function StudentPromoteAdd_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _StudentPromoteAdd)(\u0275\u0275directiveInject(ActivatedRoute));
  };
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StudentPromoteAdd, { className: "StudentPromoteAdd", filePath: "app/feature/edu/student-promote/student-promote-add/student-promote-add.ts", lineNumber: 14 });
})();
...
var SectionzAdd = class _SectionzAdd extends BaseClassTemplate {
  ...
  static \u0275fac = function SectionzAdd_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SectionzAdd)(\u0275\u0275directiveInject(ActivatedRoute));
  };
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SectionzAdd, { className: "SectionzAdd", filePath: "app/feature/edu/sectionz/sectionz-add/sectionz-add.ts", lineNumber: 18 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ClassSectionAdd, { className: "ClassSectionAdd", filePath: "app/feature/edu/class-section/class-section-add/class-section-add.ts", lineNumber: 18 });
})();
...
//# sourceMappingURL=chunk-XSMXSGYG.js.map
