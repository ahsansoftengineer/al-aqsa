...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "user",
        loadChildren: () => import("./chunk-4TDZVU7B.js").then((m) => m.UserzModule)
      },
      {
        path: "account-in",
      ...
      {
        path: "education",
        loadChildren: () => import("./chunk-6MVDQDWF.js").then((m) => m.EducationModule)
      },
      {
        path: "library",
        loadChildren: () => import("./chunk-DJPDMQBB.js").then((m) => m.EducationLibraryModule)
      },
      {
        path: "exam",
        loadChildren: () => import("./chunk-VNFRM3MT.js").then((m) => m.EducationExamModule)
      },
      {
        path: "syllabus",
        loadChildren: () => import("./chunk-3V7WDMDB.js").then((m) => m.EducationSyllabusModule)
      },
      {
        path: "file-upload",
        loadChildren: () => import("./chunk-VBSHFUPK.js").then((m) => m.FileUploadModule)
      },
      {
        path: "notification",
...
//# sourceMappingURL=chunk-HHTILKQE.js.map
